...
|                           |                               | __rangedielect__: loop over dielectscale parameter |   
...
|mtpdbfname `char`          | name file containing the molecular elements for each AA of histone core  ||
|vnuclfname `char`          | name file containing the volumes of different elements  ||
|orientfname `char`         | name file containing the triplet of segment id numbers number of AA used to orient  ||
...
|                           | to rotate and translate the nucluesome chain      ||                
...
|maxfkfunevals `int`        | maximum of fcn evaluations | if not set : default maxfkfunevlas=1000 |
