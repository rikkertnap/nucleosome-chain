...
contains
   ...
   ! input : real(dp) xsol,xvol,psi,iontype)    
    ...
    function totalcurrent() result(current_tot)
        ...
        do t=1,niontypes
            if(isionselfconsistent(t)) then
                if(iontype(t)=="Na") then 
                    ...
                    current(t) = current_J(J,iontype(t))
                endif    
                if(iontype(t)=="K") then 
